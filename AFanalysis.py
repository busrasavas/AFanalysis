...
"""
Creates an json file from the provided pkl file containing plddt, pae, max_pae, ptm and iptm scores. Draws a PAE graph showing iptm and ptm values. Also, draws a pLDDT graph showing the plddt score for each residue. 
